...
2. Copies all static assets (`images/`, every per-project dir — `itinerary-generator/`, `polindohc/`, `prevented-ocean-plastic/`, `warehouse-ops/`, `solute/`, `cutling/`, `txe-express/` — plus `locales/`, `favicon.svg`, `CNAME`, `robots.txt`)
